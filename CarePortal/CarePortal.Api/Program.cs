...
using CarePortal.Application.Services;
...
{
    opt.SwaggerDoc("v1", new OpenApiInfo { Title = "CarePortal", Version = "v1" });
...
builder.Services.AddScoped<IJobTimeService, JobTimeService>();
